...
public class TICKETS5 {
	...
	/*
	 * Every day, Mike goes to his job by a bus, where he buys a ticket. On the
	 * ticket, there is a letter-code that can be represented as a string of
	 * upper-case Latin letters.
	 * 
	 * Mike believes that the day will be successful in case exactly two different
	 ...
	 * successful for Mike or not. Print "YES" or "NO" (without quotes)
	 ...
	 * 
	 * Output For each test case, output a single line containing "YES" (without
	 * quotes) in case the day will be successful and "NO" otherwise.
	 */
